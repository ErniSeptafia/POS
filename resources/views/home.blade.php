      ...
      <ul class="nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="pages/forms/basic_elements.html">
            <i class="fa-solid fa-cube me-3"></i>
        ...
        <li class="nav-item">
          <a class="nav-link" href="pages/forms/basic_elements.html">
            ...
            <span class="menu-title">Daftar Pengeluaran</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="pages/forms/basic_elements.html">
            <i class="fa-solid fa-circle-arrow-down me-3"></i>
            <span class="menu-title">Daftar Pembelian</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="pages/forms/basic_elements.html">
            <i class="fa-solid fa-circle-arrow-up me-3"></i>
